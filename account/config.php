...
$kakaoConfig = array(
	...
	'client_id'=>'ea1c0c3992d07634c66a7fb8f09958bf',

	// ![수정필요] @@ 카카오 개발자 사이트 > 내 애플리케이션 > 카카오로그인 > 보안 에서 생성가능
	'client_secret'=>'d9S47k1SpnC8bf3dazDQ9BGxX8Dy49D6',
	...
	'redirect_uri'=>'http'.(!empty($_SERVER['HTTPS']) ? 's':null).'://'.$_SERVER['HTTP_HOST'].'/qc/account/oauth.php',
);
