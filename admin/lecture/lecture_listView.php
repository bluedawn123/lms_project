...
//인기 강의
$sql = "SELECT * FROM lecture_list WHERE ispopular = 1 ORDER BY regdate DESC";
...
//프리미엄 강의
$sql2 = "SELECT * FROM lecture_list WHERE ispremium = 1  ORDER BY regdate DESC";
...
//추천강의
$sql3 = "SELECT * FROM lecture_list WHERE isrecom = 1  ORDER BY regdate DESC";
...
//무료강의
$sql4 = "SELECT * FROM lecture_list WHERE isfree = 1  ORDER BY regdate DESC";
